...
return unsubscribeAuth;
  ...
  return (
    ...
    <Route path="/podcasts/:id/podcasts"element={<PodcastPage/>}/>
    <Route path="/profile/create-podcast" element={<CreatePodcast/>}/>
    <Route path="/profile/podcasts/:id" element={<PodcastDetails/>}/>
